...
spotifybox_container:connect_signal("button::press", function() spo_pressed() end)
spotifybox_container:connect_signal("mouse::leave", function() spo_released() end)
spotifybox_container:connect_signal("button::release", function() spo_released() end)
